...
public struct FileSystemAccessor {
    ...
    /// Creates a FileSystemAccessor.
    /// - Parameters:
    ///   - contents: Returns the contents of a folder.
